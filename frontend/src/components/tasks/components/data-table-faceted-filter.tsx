                  ...
                  <CommandItem
                    ...
                    onSelect={() => {
                      if (isSelected) {
                        ...
                        } else setTasksStatus(["IN_PROGRESS", "DONE"]);
                      } else {
                        selectedValues.add(option.value);
                        if (tasksStatus.length < 2) {
                          setTasksStatus(tasksStatus.concat(option.value));
                        } else setTasksStatus([option.value]);
                      }
                ...
                <CommandGroup>
                  <CommandItem
                    onSelect={() => {
                      ...
                      setTasksStatus(["IS_PROGRESS", "DONE"]);
                    }}
