...
public class MessageController {
    ...
    public MessageResponse createMessage(
        ...
        return MessageResponse.toResponse(messageService.create(chatId, message.content(), principal.getName()));
    }
    ...
    public MessageResponse updateMessage(
        ...
        return MessageResponse.toResponse(messageService.update(id, message.content()));
    }
}
